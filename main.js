const {sc, cxt} = CreateCanvas(600, 800, {alpha: false});
...
const hist = new RHist([9, 6, -3, 7, 5, 2], new vec2(0, 6), new vec2(80, 350), new vec2(500, 300), {strokeColor: 'rgb(255, 255, 255)', mode: RHist.DRAWMODE.stroke | RHist.DRAWMODE.fill});
...
const curve = new RCurve(points, new vec2(100, 200), new vec2(-50, 400), new vec2(-100, 100), {curveColor: 'rgb(255, 255, 0)', gridColor: 'rgb(255, 128, 255)', gridTextColor: 'rgb(256, 0, 128)'});
