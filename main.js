...
let points = [];
for (let i = -Math.PI; i < Math.PI + 0.1; i+=0.1) {
    points.push(i, Math.sin(i));
}

const animcurve = new RACurve(points, new vec2(300, 200), new vec2(-Math.PI, Math.PI), new vec2(-1, 1), new vec2(80, 100), { curveColor: 'rgb(255, 255, 0)', gridColor: 'rgb(255, 128, 255)', gridTextColor: 'rgb(256, 0, 128)' });
